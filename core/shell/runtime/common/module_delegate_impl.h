...
#ifndef CORE_SHELL_RUNTIME_COMMON_MODULE_DELEGATE_IMPL_H_
#define CORE_SHELL_RUNTIME_COMMON_MODULE_DELEGATE_IMPL_H_
...
#endif  // CORE_SHELL_RUNTIME_COMMON_MODULE_DELEGATE_IMPL_H_
