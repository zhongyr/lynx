...
RENDERER_FUNCTION_CC(AirCreateElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreatePage) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateComponent) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateBlock) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateIf) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateRadonIf) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateFor) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreatePlug) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirCreateSlot) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirAppendElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirRemoveElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirInsertElementBefore) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElementUniqueID) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElementTag) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetAttribute) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetInlineStyles) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetEvent) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetID) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElementByID) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElementByUniqueID) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetRootElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetElementByLepusID) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirUpdateIfNodeIndex) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirUpdateForNodeIndex) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirUpdateForChildCount) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetForNodeChildWithIndex) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirPushForNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirPopForNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetChildElementByIndex) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirPushDynamicNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetDynamicNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetComponentProp) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirRenderComponentInLepus) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirUpdateComponentInLepus) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetComponentInfo) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirUpdateComponentInfo) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetData) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetProps) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetData) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirFlushElement) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirFlushElementTree) { RETURN_UNDEFINED(); }
...
RENDERER_FUNCTION_CC(AirSetDataSet){RETURN_UNDEFINED()}

RENDERER_FUNCTION_CC(AirSendGlobalEvent) {
  RETURN_UNDEFINED();
}

RENDERER_FUNCTION_CC(RemoveEventListener) { RETURN_UNDEFINED(); }
...
RENDERER_FUNCTION_CC(AirCreateRawText) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirSetClasses) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirPushComponentNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirPopComponentNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirGetParentForNode) { RETURN_UNDEFINED(); }

RENDERER_FUNCTION_CC(AirFlushTree) { RETURN_UNDEFINED(); }
