...
// clang-format off
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_NAPI_TEST_NAPI_TEST_CONTEXT_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_NAPI_TEST_NAPI_TEST_CONTEXT_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_NAPI_TEST_NAPI_TEST_CONTEXT_H_
