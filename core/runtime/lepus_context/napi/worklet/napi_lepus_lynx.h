...
// clang-format off
#ifndef CORE_RUNTIME_LEPUS_CONTEXT_NAPI_WORKLET_NAPI_LEPUS_LYNX_H_
#define CORE_RUNTIME_LEPUS_CONTEXT_NAPI_WORKLET_NAPI_LEPUS_LYNX_H_
...
#endif  // CORE_RUNTIME_LEPUS_CONTEXT_NAPI_WORKLET_NAPI_LEPUS_LYNX_H_
